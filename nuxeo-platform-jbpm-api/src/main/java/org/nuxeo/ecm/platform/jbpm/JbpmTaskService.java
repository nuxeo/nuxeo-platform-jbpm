...
public interface JbpmTaskService extends Serializable {
    ...
    /**
     * Creates a task and starts it. Notifies events with names {@link JbpmEventNames#WORKFLOW_TASK_ASSIGNED} and
     * {@link JbpmEventNames#WORKFLOW_TASK_ASSIGNED}, passing the task in the event properties using key
     ...
     */
    void createTask(CoreSession coreSession, NuxeoPrincipal principal, DocumentModel document, String taskName,
     ...
     * @throws NuxeoJbpmException
     */
    boolean canEndTask(NuxeoPrincipal principal, TaskInstance task) throws NuxeoJbpmException;

    /**
     * Ends the task using event name {@link JbpmEventNames#WORKFLOW_TASK_COMPLETED} and marking the task as validated.
     *
     * @see #endTask(CoreSession, NuxeoPrincipal, TaskInstance, String, String, boolean)
     * @throws NuxeoJbpmException
     */
    ...
    /**
     * Ends the task using event name {@link JbpmEventNames#WORKFLOW_TASK_REJECTED} and marking the task as not
     * validated.
     *
     * @see #endTask(CoreSession, NuxeoPrincipal, TaskInstance, String, String, boolean)
     * @throws NuxeoJbpmException
     ...
     * @throws NuxeoJbpmException when trying to end a task without being granted the right to do so (see
     *             {@link #canEndTask(NuxeoPrincipal, TaskInstance)}), or when any other error occurs
     */
    void endTask(CoreSession coreSession, NuxeoPrincipal principal, TaskInstance task, String comment,
